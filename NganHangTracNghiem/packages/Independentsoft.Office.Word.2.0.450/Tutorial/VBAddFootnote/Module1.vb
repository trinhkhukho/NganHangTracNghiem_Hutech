...
Module Module1
    Sub Main(ByVal args() As String)
        ...
        Dim footnote1 As Footnote = New Footnote(1)
        Dim footnoteReference As FootnoteReference = New FootnoteReference(1)

        Dim footnoteRun1 As Run = New Run
        footnoteRun1.VerticalAlignment = VerticalAlignment.Superscript
        footnoteRun1.AddFootnoteReferenceMark()

        Dim footnoteRun2 As Run = New Run
        footnoteRun2.AddText("Footnote text.")

        Dim footnoteParagraph As Paragraph = New Paragraph
        ...
        Dim footnoteReferenceRun As Run = New Run
