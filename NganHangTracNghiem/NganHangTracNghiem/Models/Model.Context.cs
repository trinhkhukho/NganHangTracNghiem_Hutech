...
namespace NganHangTracNghiem.Models
{
    ...
    public partial class ObjectiveTestEntities : DbContext
    {
        ...
        public virtual ObjectResult<pro_search_Question1_Result> pro_search_Question1(Nullable<int> facultiesId, Nullable<int> subjectId, Nullable<int> chapterId, Nullable<System.DateTime> starDate, Nullable<System.DateTime> endDate)
        {
            var facultiesIdParameter = facultiesId.HasValue ?
                new ObjectParameter("FacultiesId", facultiesId) :
                new ObjectParameter("FacultiesId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pro_search_Question1_Result>("pro_search_Question1", facultiesIdParameter, subjectIdParameter, chapterIdParameter, starDateParameter, endDateParameter);
        }
    
        public virtual ObjectResult<pro_search_Question2_Result> pro_search_Question2(Nullable<int> facultiesId, Nullable<int> subjectId, Nullable<int> chapterId, Nullable<System.DateTime> starDate, Nullable<System.DateTime> endDate)
        {
            var facultiesIdParameter = facultiesId.HasValue ?
                new ObjectParameter("FacultiesId", facultiesId) :
                new ObjectParameter("FacultiesId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pro_search_Question2_Result>("pro_search_Question2", facultiesIdParameter, subjectIdParameter, chapterIdParameter, starDateParameter, endDateParameter);
        }
    
        public virtual ObjectResult<pro_search_Question3_Result> pro_search_Question3(Nullable<int> facultiesId, Nullable<int> subjectId, Nullable<int> chapterId, Nullable<System.DateTime> starDate, Nullable<System.DateTime> endDate)
        {
            var facultiesIdParameter = facultiesId.HasValue ?
                new ObjectParameter("FacultiesId", facultiesId) :
                new ObjectParameter("FacultiesId", typeof(int));
